...
public class KitchenService extends UnicastRemoteObject implements KlientService{

    private ServerService serverService;
    private int idKlienta;
    private KitchenFrame frame;

    protected void setFrame(KitchenFrame frame){
        this.frame = frame;
    }

    protected KitchenService() throws RemoteException {
        super();
        novyKlient();
    }
